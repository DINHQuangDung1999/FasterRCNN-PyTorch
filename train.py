...
from dataset.dataloader import CocoDataset, AspectRatioBasedSampler, collater
...
def train(args):
    args = EasyDict({'config_path':'config/voc_seen.yaml',
                     'checkpoint': '/home/qdinh/FasterRCNN-PyTorch/checkpoints/PascalVOC/frcnn_seen_5.pt'})
